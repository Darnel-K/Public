<#
# #################################################################################################################### #
# Filename: \Intune\PowerShell Scripts\Disable-RemoteDesktopFirewallRules.ps1                                          #
# Repository: Public                                                                                                   #
# Created Date: Sunday, January 12th 2025, 11:21:15 PM                                                                 #
# Last Modified: Sunday, January 12th 2025, 11:22:07 PM                                                                #
...
<#
.SYNOPSIS
    Disables Remote Desktop firewall rules
.DESCRIPTION
    Disables Remote Desktop firewall rules for RDP
.EXAMPLE
    & .\Disable-RemoteDesktopFirewallRules.ps1
#>
...
function init {
    try {
        ...
        $CUSTOM_LOG.Success("Remote Desktop firewall rules have been disabled.")
    }
    catch {
        $CUSTOM_LOG.Fail("An error has occured while disabling firewall rules.")
...
$SCRIPT_NAME = "Enable-RemoteDesktopFirewallRules" # This is used in the window title and the event log entries.
