<#
# #################################################################################################################### #
# Filename: \Intune\PowerShell Scripts\Enable-RemoteDesktopFirewallRules.ps1                                           #
# Repository: Public                                                                                                   #
# Created Date: Sunday, January 12th 2025, 11:17:01 PM                                                                 #
# Last Modified: Sunday, January 12th 2025, 11:21:05 PM                                                                #
...
<#
.SYNOPSIS
    Enables Remote Desktop firewall rules
.DESCRIPTION
    Enables Remote Desktop firewall rules for RDP
.EXAMPLE
    & .\Enable-RemoteDesktopFirewallRules.ps1
#>
...
function init {
    try {
        ...
        $CUSTOM_LOG.Success("Remote Desktop firewall rules have been enabled.")
    }
    catch {
        $CUSTOM_LOG.Fail("An error has occured while enabling firewall rules.")
