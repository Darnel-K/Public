...
# Repository: Public                                                                                                   #
# Created Date: Saturday, January 11th 2025, 7:53:13 PM                                                                #
# Last Modified: Saturday, January 11th 2025, 8:12:22 PM                                                               #
...
function init {
    $CUSTOM_LOG.Information("Started Setting User Locale to United Kingdom.")
    ...
    $CUSTOM_LOG.Information("Finished Setting User Locale to United Kingdom.")
    Exit 0
}
...
$SCRIPT_NAME = "Set-UserLocale(UK)" # This is used in the window title and the event log entries.
