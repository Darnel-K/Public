...
function init {
    ...
    if (beginRegistryUpdate -data $reg_data -mode $SCRIPT_EXEC_MODE) {
        ...
        $CUSTOM_LOG.Error("Wallpaper / Lockscreen Image has not been deployed, an unknown error has occured")
...
$SCRIPT_NAME = "Invoke-DeployWallpaper" # This is used in the window title and the event log entries.
