<#
# #################################################################################################################### #
# Filename: \Intune\PowerShell Scripts\Disable-FastBoot.ps1                                                            #
# Repository: Public                                                                                                   #
# Created Date: Wednesday, March 19th 2025, 11:32:20 AM                                                                #
# Last Modified: Wednesday, March 19th 2025, 11:43:47 AM                                                               #
...
.SYNOPSIS
    Disable fast boot
.DESCRIPTION
    Updates a registry key to disable fast boot / hiberboot
.EXAMPLE
    & .\Disable-FastBoot.ps1.ps1
#>
...
function init {
    ...
    $REG_DATA = @(
        [PSCustomObject]@{
            Path  = "HKLM:\SYSTEM\CurrentControlSet\Control\Session Manager\Power" # Registry key path
            Key   = "HiberbootEnabled" # Registry property Key
...
$SCRIPT_NAME = "Disable-FastBoot" # This is used in the window title and the event log entries.
