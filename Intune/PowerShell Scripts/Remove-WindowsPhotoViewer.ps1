...
# Repository: Public                                                                                                   #
# Created Date: Saturday, December 2nd 2023, 9:39:34 AM                                                                #
# Last Modified: Saturday, July 6th 2024, 1:07:23 AM                                                                   #
...
$SCRIPT_NAME = "Remove-WindowsPhotoViewer"
$SCRIPT_EXEC_MODE = "Delete" # Update or Delete. Tells the script to either update the registry or delete the keys
$REG_DATA = @(
    [PSCustomObject]@{
