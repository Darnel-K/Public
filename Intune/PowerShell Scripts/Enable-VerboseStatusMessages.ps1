...
# Last Modified: Thursday, November 23rd 2023, 3:36:56 PM                      #
...
.DESCRIPTION
    Enables Verbose Status Messages on the executing device
.EXAMPLE
...
begin {
    ...
    $LogName = "ABYSS.ORG.UK"; $LogSource = ".Intune.PSScript.Enable-VerboseStatusMessages";
