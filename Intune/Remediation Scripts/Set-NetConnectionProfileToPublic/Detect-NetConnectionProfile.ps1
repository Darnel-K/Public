...
function init {
    ...
    $CUSTOM_LOG.Information("Getting all '$NET_TYPE_TO_DETECT' profiles")
...
$SCRIPT_NAME = "Detect-NetConnectionProfile" # This is used in the window title and the event log entries.
